...
## 6.用例及界面详细设计
* ["学生列表"用例](./用例/用例_学生列表.md)，[界面](https://Neddy1995.github.io/is_analysis/test6/ui/index.html)
* ["评定成绩"用例](./用例/用例_评定成绩.md)，[界面](https://Neddy1995.github.io/is_analysis/test6/ui/评定成绩.html)
* ["查看成绩"用例](./用例/用例_查看成绩.md)，[界面](https://Neddy1995.github.io/is_analysis/test6/ui/查看成绩.html)
* ["修改密码"用例](./用例/用例_修改密码.md)，[界面](https://Neddy1995.github.io/is_analysis/test6/ui/修改密码.html)
* ["修改用户信息"用例](./用例/用例_修改用户信息.md)，[界面](https://Neddy1995.github.io/is_analysis/test6/ui/修改用户信息.html)
